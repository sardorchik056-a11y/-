...
TEXTS = {
    "ru": {
        ...
        "plot_level_line": '<tg-emoji emoji-id="5431816358675366190">🆙</tg-emoji> <i>Уровень: {level}/{max_level}</i>',
    ...
    "en": {
        ...
        "plot_level_line": '<tg-emoji emoji-id="5431816358675366190">🆙</tg-emoji> <i>Level: {level}/{max_level}</i>',
